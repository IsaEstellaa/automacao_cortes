...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _campoBordaTracejada({
    ...
    return CustomPaint(
      painter: _BordaTracejadaPainter(sombras: AppColors.sombra),
      child: TextField(
...
class _BordaTracejadaPainter extends CustomPainter {
  ...
  _BordaTracejadaPainter({this.sombras = const []});
...
class _ListrasPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = AppColors.listrasFitaVerde
      ..strokeWidth = 4;
